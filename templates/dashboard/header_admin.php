...
<header>
  ...
  <ul id="mobile-demo" class="sidenav sidenav-fixed invesible-top">
    ...
    <li><a class="c-sidenav-link grey-text text-darken-5" href="../admin/meal.php"><i class="material-icons">local_grocery_store</i>Add meal</a></li>
    <li><a class="c-sidenav-link grey-text text-darken-5" href="../admin/order.php"><i class="material-icons">history</i>Orders</a></li>
