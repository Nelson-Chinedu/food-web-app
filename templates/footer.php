<footer class="page-footer">
  <div class="c-page-footer-container">
    <div class="row">
      ...
      <div class="col l4 s12">
        <h5 class="white-text">Operating Hours</h5>
        <ul>
          <li>Mon - Fri : 9 A.m - 9 P.M</li>
          <li>Sat - Sun : 12 P.m - 6 P.M</li>
        </ul>
      </div>
    </div>
  </div>
  <div class="footer-copyright">
    <div class="container">
      ...
      <a class="c-footer-text right" href="https://nelsondev.netlify.app/" target="_blank">Made by Nelson</a>
    </div>
  </div>
</footer>
